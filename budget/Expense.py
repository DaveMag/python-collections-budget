...
class Expenses():
    ...
    def categorize_set_comprehension(self):
        necessary_expenses = {
            ...
            if x.category == 'Phone' or x.category == 'Auto and Gas' or x.category == 'Classes' or x.category == 'Utilities' or x.category == 'Mortage'
        }
        food_expenses = {
            x for x in self.list
            if x.category == 'Groceries' or x.category == 'EatingOut'
        }
